...
st.set_page_config(page_title="To Do List",page_icon="banner_top.png",layout="wide")
...
st.markdown("<br><hr><center>Created by <strong>Palak Raghuwanshi</strong></center><hr>", unsafe_allow_html=True)
